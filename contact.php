  ...
  <div class="white-wood">
    ...
    <div class="wrapper clearfix">
      ...
      <?php } else if ($_GET['s'] == 'error') { ?>
        <p> Error. Your message was not sent. Make sure you type in the proper verification numbers <a href="contact.php">Click here to try again</a>. If issues persist please send an email to the site admin. </p>
      <?php } else { ?>
        ...
        <form action="mailer.php" method="post">
          ...
          <img class="verify-img" src="verificationimage.php?<?php echo rand(0,9999) ?>" alt="verfication image">
